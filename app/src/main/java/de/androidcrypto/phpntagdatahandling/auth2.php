 ...
 */
// source: https://github.com/llagerlof/QuickAuthPHP/blob/master/auth.php
// janedoe 123456
// put password data in auth.pass file
// janedoe,$2y$10$5Gy0BUIjc7feEg2byTogQOrsY82pvYHDjRmszG2KVXT6Kk9gGntzC
// pw: 123456
// test,$2y$10$gODgCCTAJmQiwzjTZoJxs.rhW5WlAiqjlfayPrWjwWjwlUoN/6wEy
// pw: 1234
// generate password hash:
// $ php -r "echo password_hash('yourpasswordhere', PASSWORD_DEFAULT);"
// logout: attach '?logout=1' to url, eg
// http://fluttercrypto.bplaced.net/apps/ntag/auth_select_file1.php?logout=1

/**
 * The code was edited by AndroidCrypto in line
 * $passwordfile = isset($config['passwordfile']) ? dirname(__FILE__) . $config['passwordfile'] : dirname(__FILE__) . '/auth.pass';
 * old code:
